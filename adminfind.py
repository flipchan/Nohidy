...
print""
print"i will try to find the admin panel master"
 
try:
    print"programm based on an admin finder made by MasoqFellipe (i have no contact with that person)"
    print""
    var1=0
    var2=0
...
'adm/index.brf','adm.brf','affiliate.brf','adm_auth.brf','memberadmin.brf','administratorlogin.brf']
    ...
    print "5 CGI"
    print "6 BRF"
    print "\nPressione 1 e 'Enter' para Selecionar PHP\n"
    code=input("> ")
