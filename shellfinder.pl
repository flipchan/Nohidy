...
print"\n";
print "\t>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n";
print "\t> Auto shell Finder Team IHC>\n";
print "\t> >\n";
print "\t> Created By Psychotic Overlord >\n";
print "\t> >\n";
print "\t>Greetz TO :- TEAM IHC www.team-ihc.in >\n";
print "\t> Speacial Greetz to my bro Mehul Bhatt <3 >\n";
print "\t> https://www.facebook.com/bawlibottle >\n";
print "\t> https://www.facebook.com/ItsMehulBhatt >\n";
print "\t>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n";
print "\n";
 
print " Scan Your Site And Dont’ Forget To Follow Us TEAM IHC\n\n Example: http://www.victim.com (TEAM IHC HERE) \n\n-> ";
...
print "Shell Found Follow TEAM IHC: $url\n";
}else{
